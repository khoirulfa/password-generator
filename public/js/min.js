...
var generateBtn = document.getElementById('generate-btn'); // * functions
...
copyBtn.addEventListener('click', function () {
  ...
  resultField.value = '';
  sweetalert2_dist_sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('OK!', 'Password copied', 'success');
}); // * generating password
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpassword_generator"] = self["webpackChunkpassword_generator"] || [];
